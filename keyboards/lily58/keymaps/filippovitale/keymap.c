 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Space \  |RAISE |AltGr | Play |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,        KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, \
                              MT(MOD_LSFT | MOD_LALT | MOD_LGUI, KC__VOLDOWN), \
                               MT(MOD_LCTL | MOD_LALT | MOD_LGUI, KC__VOLUP), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT, \
                             KC_LALT, KC_LGUI, LOWER, KC_SPC,      KC_SPC,    RAISE,   KC_ALGR, KC_MPLY \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |   -  |  =   |
 ...
 * |   `  |      |      |      |      |      |                    |      |      |      |      |  [   |  ]   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |   1  |   2  |   3  |   4  |   5  |-------.    ,-------|      | Left | Down |  Up  |Right | Del  |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |
