 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Vol- | Vol+ | LAlt | LGUI |Lower |    Space    |Raise | RGUI | Play | PgDn | PgUp |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC__VOLDOWN, KC__VOLUP, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_MPLY, KC_PGDN, KC_PGUP  \
),
